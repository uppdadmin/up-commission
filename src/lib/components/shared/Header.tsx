            ...
            <div className="flex items-center space-x-3 sm:space-x-6">
              ...
              <div className="transform hover:scale-105 transition-transform duration-200">
                <UserButton
                  appearance={{
                    elements: {
                      avatarBox: "w-8 h-8 sm:w-10 sm:h-10 ring-2 ring-blue-100 hover:ring-blue-200 dark:ring-blue-800 dark:hover:ring-blue-700 transition-all shadow-md",
                      ...
                      menuItemButton: "dark:text-gray-300 dark:hover:bg-gray-700",
